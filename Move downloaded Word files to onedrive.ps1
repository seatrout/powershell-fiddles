...
Ganked from MSDN via google, 
 ...
 #>
$folder = 'C:\Users\Andrew\Downloads'
$filter = '*.docx'                             # <-- set this according to your requirements
$destination = 'C:\Users\Andrew\OneDrive\Documents'
